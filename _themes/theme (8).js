const a = {
  ...
  molecules: {
    ...
    form: {
      ...
      label: { fontSize: 1, override: true, unique: true },
      caption: { fontSize: 1, override: true, unique: true },
      field: {
        variant: "atoms.field",
        override: true,
  ...
  organisms: {
    feed: {
      ...
      card: { variant: "atoms.card", override: false },
      avatar: { variant: "atoms.avatar", override: false },
      name: { variant: "atoms.heading.h4", override: true, fontSize: "64px" },
      username: {
        variant: "atoms.heading.h4",
        override: true,
        fontSize: "13.9px",
      },
      date: { variant: "atoms.caption", override: true, fontSize: "37.6px" },
      heading: {
        variant: "atoms.heading.h3",
        override: false,
        h3: { variant: "atoms.heading.h3", override: false },
