const a = {
  ...
  colors: {
    primary: "hsla(208.23529411764707, 52.6021423831643%, 57.804%, 1)",
    secondary: "green",
    text: "hsla(82.08955223880602, 18.014909395522686%, 77.630079%, 1)",
    text2:
      "hsla(249.89690721649507, 57.74779061114251%, 93.27845800000001%, 1)",
    background: "hsla(114.69767282175464, 3.4800000000000013%, 18.67%, 1)",
    card: "hsla(0, 5.191184978698787%, 25.182718499999996%, 1)",
  ...
  atoms: {
    ...
    label: {
      color: "hsla(0, 51.560981483673494%, 60.424466499999994%, 1)",
      fontWeight: 900,
      fontSize: 11,
      marginBottom: "y.2",
      marginLeft: "x.5",
      ...
      borderWidth: 0,
      borderColor:
        "hsla(249.99999999999986, 78.87901937897435%, 87.3585415%, 1)",
      background: "hsla(250.00000000000003, 100%, 96.31%, 0.09)",
      width: 109,
      height: 49,
      pt: 20,
      pb: 51,
    ...
    heading: {
      ...
      h2: {
        color: "hsla(0, 38.1067746556084%, 71.7255%, 1)",
        lineHeight: 2.3,
        fontSize: 22,
        marginLeft: "x.5",
        marginRight: "x.5",
    ...
    image: {
      ...
      borderWidth: 11,
      borderColor:
        "hsla(249.99999999999994, 40.22295449765126%, 39.337354000000005%, 1)",
    },
    name: {},
    ...
    usercard: {
      ...
      height: 47,
      borderWidth: 30,
      background: "hsla(263.30232398454524, 54.428229480349%, 49.1037165%, 1)",
    },
    field: {},
    actions: {},
    background: {},
  ...
  molecules: {
    blogpost: {
      ...
      image: {
        ...
        order: 1,
        boxShadow:
          "51px 0 100px 100px hsla(0, 13.391540991042064%, 9.401054%, 1)",
        display: "",
      },
      label: {
        variant: "atoms.label",
        override: false,
        order: 2,
        textShadow: "0px 0 0 rgb(0 0 0 / 12%)",
      },
      heading: {
        ...
        order: 3,
        textShadow:
          "16px 7px 36px hsla(0, 39.60631020522128%, 45.363279%, 1), 0 0 0",
      },
      paragraph: {
        ...
        order: 4,
        textShadow:
          "15px 44px 47px hsla(0, 32.14296582104652%, 87.709454%, 1), 0px 0 0",
      },
      usercard: {
