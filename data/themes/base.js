export const base = {
  ...
  atoms: {
    ...
    heading: { ml: 24, fontWeight: 200, color: 'red' },
    ...
    name: {},
    caption: {},
    avatar: { borderRadius: 48, width: 40, height: 40 },
  ...
  molecules: {
    blogpost: {
      ...
      props: {
        ...
        authorAvatar:
          'https://reasons.to/content/0-2017/2-brighton/1-speakers/0-elliot-jay-stocks/elliot-jay-stocks.jpg',
        caption: 'Feb 12, 2022  ·  11 min read',
      },
    },
    form: { card: {} },
    feeditem: {
      card: { width: 528, ml: 24, mr: 24, pt: 8 },
      avatar: { width: 48, height: 48, minWidth: 48, minHeight: 48 },
      name: { display: 'block' },
      username: {},
