export const redGreenPurpleBlue = {
  name: 'rgpb',
  label: 'rgpb',
  type: 'light',
  space: { base: { x: 4, y: 4 } },
  ...
  lineHeights: ['280%'],
  colors: {
    text: 'hsla(82.08955223880605, 45.31715469011116%, 41.860164499999996%, 1)',
    text2: 'hsla(249.89690721649492, 89.50745868210873%, 72.933154%, 1)',
    background: 'hsla(0, 63.92099008278008%, 12.298608000000002%, 1)',
  ...
  atoms: {
    ...
    input: {
      ...
      borderRadius: 6,
      background: 'hsla(0, 7.6658053402239466%, 37.922904%, 1)',
  ...
  molecules: {
    ...
    form: {
      card: {
        background: 'hsla(249.99999999999991, 6.230000000000007%, 16.47%, 0)',
        boxShadow:
          '10px 20px 80px hsla(0, 50.795445977531486%, 49.17920399999999%, 1), 0 0 0',
        pt: 40,
        pb: 60,
        pl: 50,
        pr: 50,
