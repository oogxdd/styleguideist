...
hackClubTheme.util.cx = (c) => hackClubTheme.colors[c] || c
hackClubTheme.util.gx = (from, to) => `radial-gradient(
  ellipse farthest-corner at top left,
  ${hackClubTheme.util.cx(from)},
  ${hackClubTheme.util.cx(to)}
)`
hackClubTheme.util.gxText = (from, to) => ({
  color: hackClubTheme.util.cx(to),
  [hackClubTheme.util.supportsClipText]: {
    backgroundImage: hackClubTheme.util.gx(from, to),
...
hackClubTheme.cards.translucent = {
  // variant: 'cards.primary',
  backgroundColor: 'rgba(255, 255, 255, 0.98)',
  color: 'text',
  boxShadow: 'none',
  [hackClubTheme.util.supportsBackdrop]: {
    backgroundColor: 'rgba(255, 255, 255, 0.75)',
    backdropFilter: 'saturate(180%) blur(20px)',
    WebkitBackdropFilter: 'saturate(180%) blur(20px)',
  },
  [hackClubTheme.util.reduceTransparency]: {
    backdropFilter: 'none',
    WebkitBackdropFilter: 'none',
  },
}
hackClubTheme.cards.translucentDark = {
  // variant: 'cards.primary',
