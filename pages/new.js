  ...
  return (
    <div className="w-screen h-screen bg-gray-2 flex flex-col items-center pt-16">
      <div className="relative mb-8 flex flex-col items-center">
        <h1 className="mb-4 text-gray-12 text-3xl">MakeUI.ai</h1>
        <input
          className="bg-gray-3 rounded-full placeholder:text-gray-9 text-gray-11 px-3 py-2 w-80
