const FloatingWindow = () => {
  return (
    <div
      className="w-screen h-screen _bg-sand-2"
      style={
        {
          // backgroundImage:
          // 'radial-gradient(ellipse at 65% 23%, hsla(280.28,66.51%,42.16%,0.8424494782952627) 22%, hsla(143.31,63.56%,51.57%,0.3408091354700824) 63%), repeating-radial-gradient(circle at 50% 59%, hsla(247.5,100%,85.88%,0.6161404063523175) 11%, hsla(11.76,84.53%,35.49%,0.4512172026204424) 73%), repeating-conic-gradient(from 139deg at 79% 86%, hsla(313.42,63.87%,53.33%,0.0626293485287428) 24%, hsla(244.29,7.37%,37.25%,0.3658005417020309) 81%), conic-gradient(from 350deg at 88% 67%, hsla(280.34,70.16%,51.37%,0.4294863144489922) 70%, hsla(57.61,97.1%,59.41%,0.9062861870250993) 76%), linear-gradient(247deg, #595866 45%, #fff5ed 99%)',
          // filter: 'grayscale(1) brightness(0.1)',
        }
      }
    >
      <div className="flex flex-col h-screen w-[calc(100vw)] items-center pt-20">
        <h1 className="text-sand-11 text-center font-medium">
          <span className="text-3xl text-sand-12">Make UI</span>
          <br />
          <span className="text-2xl">For your next thing</span>
        </h1>
        <div className="flex flex-col items-center mt-8">
          <input
            placeholder="Type what you want to build"
            className="bg-sand-6 text-sand-12 py-1 px-2.5 rounded-full w-80 text-md h-12 placeholder:text-sand-9 font-thin"
          />
          <span className="mt-3 text-sand-8 text-sm opacity-80">
            eg "e-commerce shop for kids"
          </span>
        </div>
      </div>
      <div
        className="fixed top-4 left-4 h-[930px] w-[400px] bg-sandA-3 hover:bg-sandA-4 rounded-md cursor-move z-10"
        style={{
          boxShadow:
            '0px 1px 1px 0px rgba(0, 0, 0, 0.11), 0px 2px 2px 0px rgba(0, 0, 0, 0.11), 0px 4px 4px 0px rgba(0, 0, 0, 0.11), 0px 6px 8px 0px rgba(0, 0, 0, 0.11), 0px 8px 16px 0px rgba(0, 0, 0, 0.11)',
        }}
      ></div>
      <div
        className="fixed top-4 right-4 h-[930px] w-[400px] bg-sandA-3 hover:bg-sandA-4 rounded-md cursor-move"
        style={{
          boxShadow:
            '0px 1px 1px 0px rgba(0, 0, 0, 0.11), 0px 2px 2px 0px rgba(0, 0, 0, 0.11), 0px 4px 4px 0px rgba(0, 0, 0, 0.11), 0px 6px 8px 0px rgba(0, 0, 0, 0.11), 0px 8px 16px 0px rgba(0, 0, 0, 0.11)',
        }}
